...
for i in selectedTests:
    ...
    os.system(pMoldyn + ' --csf --input=DCSF%s_Reference.inp' % i)
    os.system('mv DCSF_Fqt_test.nc Fqt%s_Reference.nc' % i)
    os.system('mv DCSF_Sqw_test.nc Sqw%s_Reference.nc' % i)
